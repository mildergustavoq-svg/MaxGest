...
fondo = ctk.CTkImage(
    light_image = Image.open("assets/fondo_inicio.png"),
    dark_image = Image.open("assets/fondo_inicio.png"),
    size=(900, 550),
)
...
logo=ctk.CTkImage(
    light_image=Image.open("assets/logo C.png"),
    dark_image=Image.open("assets/logo C.png"),
    size=(200, 150)
)
